...
int main(int argc, char* argv[]) {
    ...
    if (game->Initialize("Mario-style 2D Game", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 
        ...
        std::cout << "" << std::endl;
        std::cout << "=== ゲームルール ===" << std::endl;
        std::cout << "🎯 敵を上から踏みつけて倒そう！ (+100点)" << std::endl;
        std::cout << "⚠️  横から当たるとダメージを受ける！" << std::endl;
        std::cout << "❤️  ライフ: 3 | ゲームオーバー後も無限プレイ可能" << std::endl;
        std::cout << "🔄 ダメージ後は1秒間無敵＆点滅表示" << std::endl;
        std::cout << "" << std::endl;
